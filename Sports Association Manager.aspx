<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sports Association Manager.aspx.cs" Inherits="Fantasy.Sports_Association_Manager" %>
...
<%--                <button class="btn btn-primary d-grid w-100">Sign up</button>--%>
                    ...
                    <asp:Button ID="Reg" class="btn btn-primary d-grid w-100" runat="server" onClick="onRegisterSAM" Text="Sign Up" />
