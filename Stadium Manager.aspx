<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stadium Manager.aspx.cs" Inherits="Fantasy.Stadium_Manager" %>
            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" method="POST" runat="server">
                ...
                <div class="mb-3 form-password-toggle">
                 ...
                 <div class="mb-3">
                    <label for="dropdownstadium" class="form-label">Choose your stadium</label> <br />
                    <asp:DropDownList ID="dropdownstadium" CssClass="form-select color-dropdown" runat="server"></asp:DropDownList>
                ...
                <div class="mb-3">
                    ...
                    <asp:Button ID="Reg" class="btn btn-primary d-grid w-100" runat="server" onClick="onRegisterSM" Text="Sign Up" />
